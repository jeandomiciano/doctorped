...
class idadebaixa25 extends StatelessWidget {
  const idadebaixa25({Key? key}) : super(key: key);
                            ...
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      ...
                                      '⦁	Se não responsivo e ventilação ausente ou gasping, mover o paciente para uma superfície plana, rígida e seca, colocando-o em decúbito dorsal.\n\n'
                                      '⦁	Checar o pulso central por 10 segundos.\n\n'
                                      '⦁	Realizar o contato com o SAMU.\n\n'
                                      '⦁	Aguardar as orientações para seguir com os procedimentos.\n\n',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
