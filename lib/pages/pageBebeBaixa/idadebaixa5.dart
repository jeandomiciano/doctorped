...
class idadebaixa5 extends StatelessWidget {
  const idadebaixa5({Key? key}) : super(key: key);
                          ...
                          child: SingleChildScrollView(
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      '⦁	Processo mais importante na reanimação do RN.\n\n'
                                      '⦁	Realizar se a FC < 100.\n\n'
                                      '⦁	Iniciar a VPP com ar ambiente(O2 a 21%).\n\n'
                                      '⦁	Deve ser contantemente verificada e corrigir a tecnica de VPP antes de oferecer O2 suplementar.',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
