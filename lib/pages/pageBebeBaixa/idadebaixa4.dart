...
class idadebaixa4 extends StatelessWidget {
  const idadebaixa4({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    String img = "assets/tela04.png";
                          ...
                          child: SingleChildScrollView(
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      '⦁	Os RN que não precisam de procedimentos de reanimação, a SatO2 com 1 minuto de vida'
                                      ' se situa ao redor de 60-65%, só atingindo valores entre 87-92% no 5º minuto.',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
