...
class idadebaixa2 extends StatelessWidget {
  const idadebaixa2({Key? key}) : super(key: key);
                          ...
                          child: SingleChildScrollView(
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      '⦁	É um indicador de reanimação neonatal.\n\n'
                                      '⦁	Auscultar a criança por 6 segundos e multiplicar por 10  a FC estará adequada se maior que 100.\n\n'
                                      '⦁	Se ao nascer a FC estiver abaixo de 100 bpm é considerada bradicardia e deve ser realizado VPP.',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
