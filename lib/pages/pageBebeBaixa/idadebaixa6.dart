...
class idadebaixa6 extends StatelessWidget {
  const idadebaixa6({Key? key}) : super(key: key);
                          ...
                          child: SingleChildScrollView(
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      '⦁	Balão autoinflável.\n\n'
                                      '-	No período neonatal são utilizados os blões de 240 mL.\n\n'
                                      '-	A pressão inspiratória máxima deve ser 30 – 40 cm H2O.\n\n'
                                      '⦁	Balão inflado por fluxo.\n\n'
                                      '⦁	Ventilador mecânico manual com peça T.\n\n'
                                      '-	Necessita de uma fonte de gas comprimido.\n\n',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
                              ...
                              //           fontWeight: FontWeight.w500,
                              //         ),
                              //         text: "www.sbp.com.br/reanimacao.",
                              //         recognizer: TapGestureRecognizer()
                              //           ..onTap = () async {
                              //             var url =
                              //                 "https://pub.dev/documentation/flutter_linkify/latest/";
