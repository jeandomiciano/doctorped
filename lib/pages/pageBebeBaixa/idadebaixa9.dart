...
class idadebaixa9 extends StatelessWidget {
  const idadebaixa9({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    String img1 = "assets/tela05.png";
    String img2 = "assets/tela06.png";
    String img3 = "assets/tela08.png";
