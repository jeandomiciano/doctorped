...
class idadebaixa23 extends StatelessWidget {
  const idadebaixa23({Key? key}) : super(key: key);
                            ...
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      ...
                                      ' ⦁	Considerar a abordagem específica:\n\n'
                                      ' 1) Acalmar o paciente\n\n'
                                      ' 2) Executar a manobra de Heimlich\n\n'
                                      ' ⦁	Ficar atendo na possibilidade de uma parada cardiorrespiratória (PCR).\n\n',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
