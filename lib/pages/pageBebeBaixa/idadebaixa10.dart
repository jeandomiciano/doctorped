...
class idadebaixa10 extends StatelessWidget {
  const idadebaixa10({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    String img = "assets/tela07.png";
                          ...
                          child: SingleChildScrollView(
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      '⦁	No RN ≥34 semanas, a VPP deve ser iniciada com ar ambiente (O2 a 21%).\n\n'
                                      '⦁	Os valores de SatO2 alvo variam de acordo com os minutos de vida (olhar no tópico de saturação).\n\n'
                                      '⦁	Se a SatO2 pré-ductal estiver abaixo do alvo, aumentar a concentração de O2 para 40% e aguardar 30 segundos.\n\n'
                                      '⦁	Se não melhorar, aumentar a concentração de O2 para 60% e assim sucessivamente a cada 30 segundos, se necessário, acompanhando-se a SatO2 alvo.',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
