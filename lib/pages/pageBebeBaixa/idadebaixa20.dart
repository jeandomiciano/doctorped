...
class idadebaixa20 extends StatelessWidget {
  const idadebaixa20({Key? key}) : super(key: key);
                            ...
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      ...
                                      '⦁	Avaliar permeabilidade de via aérea e corrigir situações de risco  Realizar a hiperextensão da cabeça e elevação do queixo, inserir a cânula orofaríngea, realizar aspiração e retirada de próteses, se necessário.\n\n'
                                      '⦁	Avaliar a ventilação.\n\n'
                                      '⦁	Avaliar o estado circulatório  presença de sangramentos, tempo de enchimento capilar, verificar pulsos, entre outros.\n\n'
                                      '⦁	Avaliação do estado neurológico: escala de coma de Glasgow.\n\n',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
