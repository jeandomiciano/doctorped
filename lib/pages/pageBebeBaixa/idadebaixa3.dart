...
class idadebaixa3 extends StatelessWidget {
  const idadebaixa3({Key? key}) : super(key: key);
                          ...
                          child: SingleChildScrollView(
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      '⦁	Olhar se o tórax do recém-nascido está expandindo adequadamente e/ou se há choro.\n\n'
                                      '⦁	Se os movimentos respiratórios forem irregulares ou no padrão gasping, a respiração esta inadequada.',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
