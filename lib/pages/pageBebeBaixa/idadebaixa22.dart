...
class idadebaixa22 extends StatelessWidget {
  const idadebaixa22({Key? key}) : super(key: key);
                          ...
                          child: SingleChildScrollView(
                            child: Column(children: <Widget>[
                              Container(
                                  ...
                                  child: const Text(
                                      '⦁	É realizada quando o paciente apresenta algum agravo clinico, identificado após a avaliação primaria.\n\n'
                                      '⦁	Conduta: realizar a entrevista “SAMPLA”  Primeiro identifica questionando sobre o nome, idade e queixa principal.\n\n'
                                      '- S = sinais vitais\n'
                                      '- A = alergias\n'
                                      ...
                                      '⦁	Posteriormente realiza avaliação complementar, com a oximetria de pulso e glicemia capilar, se possível.\n\n'
                                      '⦁	Exame crânio – caudal, focando para cada sistema: cabeça, face, pescoço, tórax ...\n\n',
                                      style: TextStyle(
                                        color: Color.fromARGB(211, 68, 40, 133),
                                        fontSize: 30,
                                        fontWeight: FontWeight.w500,
